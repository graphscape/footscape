...
public class ProxyViewSupport<T extends WidgetI> extends ViewSupport {
	...
	public ProxyViewSupport(ContainerI ctn, Class<T> wcls) {
		this(ctn, create(ctn, wcls));
	}
	...
	public static <T extends WidgetI> T create(ContainerI ctn, Class<T> wcls) {
		WidgetFactoryI wf = getWidgetFactory(ctn);
		T rt = wf.create(wcls);
