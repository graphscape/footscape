...
public class Actions {
	...
	public static final Path A_ACT_REFRESH = A_ACT.getSubPath("refresh");// refresh
																			// participant
	...
	public static final Path A_UEL_CREATE = A_UELIST.getSubPath("create");// link to new exp edit view.

	public static final Path A_UEL_SELECT = A_UELIST.getSubPath("open");// open the default view of the
